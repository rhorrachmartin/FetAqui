...
/**
 * Clase encarga de confirmar el usuario una vez se ha registrado y ha
 * confirmado su activación por correo electrónico
 * 
 * @author ramon
 *
 */
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (session == null) {
				...
				// Recogemos el código de activación que viene "incrustado" en el link del email
				// recibido por
				// el usuario
