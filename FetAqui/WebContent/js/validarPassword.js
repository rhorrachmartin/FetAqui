...
$(function() {
	...
	$password.on("input blur", function(e) {
		...
		if (leng == true && bigLetter == true && num == true
			...
			$passwordAlert.removeClass("alert-warning").addClass(
					"alert-success");
			ok = true;
			...
			$passwordAlert.removeClass("alert-success").addClass(
					"alert-warning");
		...
		if(ok){
			...
			$("#registrarse2").prop('disabled',false);
		}else{
			$("#registrarse").prop('disabled',true);
			$("#registrarse2").prop('disabled',true);
		}
	});
