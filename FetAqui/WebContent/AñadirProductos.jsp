							...
							<form action="AñadirProducto" method="post"
								...
								<div class="form-group">
									<label for="stock">Stock </label> <input type="number"
										...
										<small id="ayudaStock"
										class="form-text text-muted">Cantidad disponible para la venta</small>
								</div>
								...
								<div class="custom-file">
									...
									<label id="labelFoto" class="custom-file-label"
										...
										<small id="ayudaFoto"
										class="form-text text-muted">Si no elige una, se establecerá una por defecto</small>
								</div>
								...
								<div class="custom-control custom-switch">
									<input type="checkbox" class="custom-control-input"
										...
										for="customSwitch1">Activar venta Online</label>
										<small id="ayudaVentaOnline"
										class="form-text text-muted">Activado por defecto</small>
								</div>
